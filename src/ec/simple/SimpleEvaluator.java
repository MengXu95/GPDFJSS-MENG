...
public class SimpleEvaluator extends Evaluator
    ...
    protected int individualCounter = 0;
    protected int subPopCounter = 0;
    public int chunkSize;  // a value >= 1, or C_AUTO
    ...
    protected void expand(EvolutionState state)
        {
    ...
    protected void contract(EvolutionState state)
        {
        // swap back
...
public class SimpleEvaluatorThread implements Runnable
        {
