...
public abstract class GPNodeBuilder implements Prototype
    ...
    public abstract GPNode newRootedTree(final EvolutionState state,
        ...
        //modified by mengxu to decide the treeNum, because we have 2 tree.
        public GPNode newRootedTreeMcts(EvolutionState state,
                                                 GPType type,
                                                 int thread,
                                                 GPNodeParent parent,
                                                 GPFunctionSet set,
        ...
        //modified by mengxu to decide the treeNum, because we have 2 tree.
        public GPNode newRootedTreeMctsMutation(EvolutionState state,
                                                GPType type,
                                                int thread,
                                                GPNodeParent parent,
                                                GPFunctionSet set,
