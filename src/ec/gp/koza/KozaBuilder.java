...
//                GPNode n = mctsTreeNode.expandNewTerminalRandom(state, thread);
                ...
                }else if(this.mctsPolicy.equals("mean-non-infinity-reward-linked-pro-v2")){
                    n = mctsTreeNode.expandNewTerminalBasedOnMinMeanNonInfinityRewardLinkedWithProbability(state, thread);
                }else if(this.mctsPolicy.equals("mean-non-infinity-reward-linked-v2")){
                    n = mctsTreeNode.expandNewTerminalBasedOnMinMeanNonInfinityRewardLinked(state, thread);
                }else if(this.mctsPolicy.equals("mean-non-infinity-reward-v2")){
                    n = mctsTreeNode.expandNewTerminalBasedOnMinMeanNonInfinityReward(state, thread);
                }else{
                    n = null;
...
//                GPNode n = mctsTreeNode.expandNewChildRandom(state, thread);
                ...
                if(this.mctsPolicy.equals("mean-non-infinity-reward")){
                    ...
                    n = mctsTreeNode.expandNewChildBasedOnMinMeanNonInfinityRewardLinkedWithProbabilityV2(state, thread);
                }else if(this.mctsPolicy.equals("mean-non-infinity-reward-linked-v2")){
                    n = mctsTreeNode.expandNewChildBasedOnMinMeanNonInfinityRewardLinkedV2(state, thread);
                }else if(this.mctsPolicy.equals("mean-non-infinity-reward-v2")){
                    n = mctsTreeNode.expandNewChildBasedOnMinMeanNonInfinityRewardV2(state, thread);
                }else{
                    n = null;
                    System.out.println("Wrong! need mctsPolicy parameter.");
                }
