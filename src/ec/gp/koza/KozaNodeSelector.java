...
//        //add by mengxu 2021.12.29 to pick a number of different nodes
//        public List<GPNode> pickNodes(final EvolutionState s,
//                                      final int subpopulation,
//                                      final int thread,
//                                      final GPIndividual ind,
//                                      final GPTree tree,
...
//                //including the terminals    all the possible positions
//                {
//                    //add by mengxu 2021.12.29
//                    int permSize = nodes;
//                    int[] permutation = new int[permSize];
//                    MOEADUtils.randomPermutation(s, thread, permutation, permSize);
//                    List<GPNode> nodes = new ArrayList<>();
//                    for(int i=0; i<numNodes; i++){
//                        nodes.add(tree.child.nodeInPosition(permutation[i], GPNode.NODESEARCH_ALL));
//                    }
//                    return nodes;
//
////                    return tree.child.nodeInPosition(s.random[thread].nextInt(nodes), GPNode.NODESEARCH_ALL);
...
//            else if (rnd > nonterminalProbability + terminalProbability)  // pick the root
//            {
//                //add by mengxu 2021.12.29 one node is the root node
...
//                if (terminals==-1) terminals = tree.child.numNodes(GPNode.NODESEARCH_TERMINALS);
//                //add by mengxu 2021.12.29
//                int permSize = terminals;
//                int[] permutation = new int[permSize];
//                MOEADUtils.randomPermutation(s, thread, permutation, permSize);
//                List<GPNode> nodes = new ArrayList<>();
//                for(int i=0; i<numNodes; i++){
//                    nodes.add(tree.child.nodeInPosition(permutation[i], GPNode.NODESEARCH_TERMINALS));
//                }
//                return nodes;
////                return tree.child.nodeInPosition(s.random[thread].nextInt(terminals), GPNode.NODESEARCH_TERMINALS);
//                //choose the terminals
...
//                {
//                    //add by mengxu 2021.12.29
//                    int permSize = nonterminals;
//                    int[] permutation = new int[permSize];
//                    MOEADUtils.randomPermutation(s, thread, permutation, permSize);
//                    List<GPNode> nodes = new ArrayList<>();
//                    for(int i=0; i<numNodes; i++){
//                        nodes.add(tree.child.nodeInPosition(permutation[i], GPNode.NODESEARCH_NONTERMINALS));
//                    }
//                    return nodes;
////                    return tree.child.nodeInPosition(s.random[thread].nextInt(nonterminals), GPNode.NODESEARCH_NONTERMINALS);
//                    //choose nodes
