...
import ec.simple.*;
import ec.util.*;
import mengxu.algorithm.multiobjective.NSGPII.NSGA2EvaluatorNoEnvironmentalSelection;
import mengxu.algorithm.multiobjective.NSGPII.zScore.NSGA2EvaluatorNoEnvironmentalSelectionNormalisation;
import mengxu.algorithm.multiobjective.oneInstanceMultiCaseLexicaseSelection.NSGA2EvaluatorNoEnvironmentalSelectionLSMO;
...
public class NSGA2Evaluator extends SimpleEvaluator {
	...
	public void evaluatePopulation(final EvolutionState state) {
		...
		if(this instanceof NSGA2EvaluatorNoEnvironmentalSelectionNormalisation || this instanceof NSGA2EvaluatorNoEnvironmentalSelectionLSMO){
