...
public abstract class Individual implements Prototype, Comparable
    ...
    //fzhang 15.7.2018  in order to get the number of trees in individual
    ...
    */
    ...
    public void readIndividualWithoutFitness(final EvolutionState state,
                               final LineNumberReader reader)
            throws IOException
        {
            evaluated = Code.readBooleanWithPreamble(EVALUATED_PREAMBLE, state, reader);
...
//            fitness.readFitness(state, reader);
    ...
    */
    ...
    //fzhang 15.7.2018  get the number of trees
    public int numTrees(final EvolutionState state, final Parameter base) {
