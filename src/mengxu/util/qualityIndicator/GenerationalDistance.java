...
public class GenerationalDistance {
   ...
   */
  public double generationalDistance_MaxMin(EvolutionState state,
                                            double [][] front,
...
//    minimumValue = utils_.getMinimumValues(trueParetoFront, numberOfObjectives);
    ...
    public double generationalDistance_Manual(EvolutionState state,
                                              double [][] front,
                                              double [][] trueParetoFront,
                                              double [] manualObj,
                                              int numberOfObjectives) {
        ...
        double sum = 0.0;
        for (int i = 0; i < front.length; i++){
            double[] aNormalizedFront = normalizedFront[i];
            sum += Math.pow(utils_.distanceToClosedPoint(aNormalizedFront,
                            normalizedParetoFront),
                    pow_);
        }
  ...
  public static void main(String args[]) {
    ...
    double value = qualityIndicator.generationalDistance_MaxMin(null,
    		                                 solutionFront,
    		                                 trueFront,
