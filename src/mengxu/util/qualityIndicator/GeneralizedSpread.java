...
public class GeneralizedSpread {
  ...
  public static mengxu.util.qualityIndicator.util.MetricsUtil utils_;  // MetricsUtil provides some
  ...
  public double generalizedSpread(double [][] paretoFront,
    ...
    for (int i = 0; i < numberOfObjectives; i++) {
      Arrays.sort(normalizedParetoFront,new mengxu.util.qualityIndicator.util.ValueComparator(i));
    ...
    Arrays.sort(normalizedFront,new mengxu.util.qualityIndicator.util.LexicoGraphicalComparator());
