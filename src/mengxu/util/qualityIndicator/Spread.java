...
public class Spread {
  ...
  public static mengxu.util.qualityIndicator.util.MetricsUtil utils_;//utils_ is used to access to
  ...
  public double spread(double [][] front, 
    ...
    Arrays.sort(normalizedFront,
    		    new mengxu.util.qualityIndicator.util.LexicoGraphicalComparator());
