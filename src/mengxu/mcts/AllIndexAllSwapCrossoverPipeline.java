...
//                        GPTree gpTree0 = ((GPIndividual)j1).trees[0];
//                        GPTree gpTree1 = ((GPIndividual)j1).trees[1];
//                        ((GPRuleEvolutionStateUpdateLate) state).mctses[0].frontPropagateVisitCount(gpTree0, j1.fitness.fitness());
//                        ((GPRuleEvolutionStateUpdateLate) state).mctses[1].frontPropagateVisitCount(gpTree1, j1.fitness.fitness());
//                    }
//                }
//            }
...
//                        if (mctsUpdateRate) {
//                            if(mctsPolicy.equals("visitCount")){
//                                GPTree gpTree0 = ((GPIndividual)j2).trees[0];
//                                GPTree gpTree1 = ((GPIndividual)j2).trees[1];
//                                ((GPRuleEvolutionStateUpdateLate) state).mctses[0].frontPropagateVisitCount(gpTree0, j2.fitness.fitness());
//                                ((GPRuleEvolutionStateUpdateLate) state).mctses[1].frontPropagateVisitCount(gpTree1, j2.fitness.fitness());
//                            }
//                        }
//                    }
