...
public class TrainDiversity {
	 ...
	 public static final long simSeed = 968356;
	    ...
	    public TrainDiversity(String trainPath, RuleTypeV2 ruleType, int numRuns,
...
//	                    "RoutRuleUniqueTerminals,Obj,TrainFitness,TestFitness,TrainTime");
		...
		public static void main(String[] args) {
			...
			TrainDiversity multipletreeruleTest = new TrainDiversity(trainPath, ruleType, numRuns, testScenario, testSetName, numTrees);
