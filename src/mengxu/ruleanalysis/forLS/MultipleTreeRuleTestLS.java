package mengxu.ruleanalysis.forLS;
...
public class MultipleTreeRuleTestLS {
	 ...
	 public static final long simSeed = 968356;
	    ...
	    public MultipleTreeRuleTestLS(String trainPath, RuleTypeV2 ruleType, int numRuns,
...
//	                                numUniqueTerminals + ",");
		...
		public static void main(String[] args) {
			...
			MultipleTreeRuleTestLS multipletreeruleTest = new MultipleTreeRuleTestLS(trainPath, ruleType, numRuns, testScenario, testSetName, numTrees);
