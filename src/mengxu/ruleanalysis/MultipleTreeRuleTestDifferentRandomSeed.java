...
public class MultipleTreeRuleTestDifferentRandomSeed {
	 ...
	 public static final long simSeed = 968356;
	    ...
	    public MultipleTreeRuleTestDifferentRandomSeed(String trainPath, RuleTypeV2 ruleType, int numRuns,
		...
		public SchedulingSet generateTestSet() {
	        return SchedulingSet.generateSetDifferentRandomSeed(simSeed, testScenario,//modified by mengxu 2022.03.08
	                testSetName, objectives, 1,50);
	    }

		public void writeToCSV() {
	        SchedulingSet testSet = generateTestSet();
	        File targetPath = new File(trainPath + "testRandom"); //create a folder named "test" in trainPath
...
//	                                numUniqueTerminals + ",");
		...
		public static void main(String[] args) {
			...
			MultipleTreeRuleTestDifferentRandomSeed multipletreeruleTest = new MultipleTreeRuleTestDifferentRandomSeed(trainPath, ruleType, numRuns, testScenario, testSetName, numTrees);
