...
public class MOWeightedMultipleTreeRuleTestSingleRun {
	 ...
	 public static final long simSeed = 968356;
	    ...
	    public MOWeightedMultipleTreeRuleTestSingleRun(String trainPath, RuleTypeV2 ruleType, int indexOfRun,
		...
		public void writeToCSV() {
			...
			//add by mengxu 2025.2.21
			double[] baselineObjectives = new double[objectives.size()];
			testSet.lowerBoundsFromBenchmarkRule(objectives);
			for(int i=0; i<baselineObjectives.length; i++){
				baselineObjectives[i] = testSet.getObjectiveLowerBoundMtx().getEntry(i,0);
			}
	            ...
	            //for (int j = 42; j < result.getGenerationalRules().size(); j++) {
	             for (int j = 0; j < result.getGenerationalRules().size(); j++) {
	                ...
	                System.out.println("Generation " + j + ": test fitness = " +
							...
							((MultiObjectiveFitness)result.getGenerationalTestFitness(j)).objectives[1]);
	            }
...
//	        }
	        ...
	        try {
	            ...
	            writer.write("Run,Generation,SeqRuleSize,SeqRuleUniqueTerminals,RoutRuleSize," +
	                    "RoutRuleUniqueTerminals,Obj,TrainFitness0,TestFitness0,TrainFitness1,TestFitness1," +
						"Baseline0,Baseline1,TrainTime");
//				writer.write("Run,Generation,SeqRuleSize,SeqRuleUniqueTerminals,RoutRuleSize," +
...
//									result.getGenerationalParentSelectionDiversityStat(j));
							...
							writer.write(baselineObjectives[0] + "," + baselineObjectives[1] + "," + result.getGenerationalTime(j));
	                        writer.newLine();
	                    }
	                }
//	            }
		...
		public static void main(String[] args) {
			...
			MOWeightedMultipleTreeRuleTestSingleRun multipletreeruleTest = new MOWeightedMultipleTreeRuleTestSingleRun(trainPath, ruleType, indexofRun, testScenario, testSetName, numTrees);
