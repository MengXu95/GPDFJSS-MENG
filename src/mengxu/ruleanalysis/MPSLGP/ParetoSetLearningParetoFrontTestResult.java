 ...
 * 2022.08.11
 */
public class ParetoSetLearningParetoFrontTestResult {
	...
	private List<Integer> generationalGenerationNumbers;
	private List<List<Integer>> generationalTaskIndices;
	...
	private List<List<EnsembleRule>> generationalEnsembleRules;
	private List<List<List<Fitness>>> generationalEnsembleTrainFitnesses;  //generational things is a list to contain informaiton related
	private List<List<Fitness>> generationalEnsembleTestFitnesses;  //generational things is a list to contain informaiton related
	private EnsembleRule ensembleRule;
	private List<List<List<Double>>> generationalTestEnsembleContribution;

	public static final long validationSimSeed = 483561;

	public ParetoSetLearningParetoFrontTestResult() {
		...
		generationalGenerationNumbers = new ArrayList<>();
		generationalTaskIndices = new ArrayList<>();
	...
	public void setGenerationalEnsembleRules(List<List<EnsembleRule>> generationalRules) {
		this.generationalEnsembleRules = generationalRules;
	}

	public List<List<EnsembleRule>> getGenerationalEnsembleRules() {
		return generationalEnsembleRules;
	}

	public void addGenerationalEnsembleRules(List<EnsembleRule> rules) {
		this.generationalEnsembleRules.add(rules);
	}

	public void setGenerationalEnsembleTrainFitnesses(List<List<List<Fitness>>> generationalEnsembleTrainFitnesses) {
		this.generationalEnsembleTrainFitnesses = generationalEnsembleTrainFitnesses;
	}

	public List<List<List<Fitness>>> getGenerationalEnsembleTrainFitnesses() {
		return generationalEnsembleTrainFitnesses;
	}

	public List<List<Fitness>> getGenerationalEnsembleTrainFitnessesGen(int gen) {
		return generationalEnsembleTrainFitnesses.get(gen);
	}

	public List<List<List<Double>>> getGenerationalTestEnsembleContribution() {
		return generationalTestEnsembleContribution;
	}

	public void addGenerationalEnsembleTrainFitness(List<List<Fitness>> f) {
		this.generationalEnsembleTrainFitnesses.add(f);
	}


	public List<List<Fitness>> getGenerationalEnsembleTestFitnesses() {
		return generationalEnsembleTestFitnesses;
	}

	public List<Fitness> getGenerationalEnsembleTestFitnessesGen(int gen) {
		return generationalEnsembleTestFitnesses.get(gen);
	}

	public void addGenerationalEnsembleTestFitnesses(List<Fitness> f) {
	...
	public int getGenerationalGenerationNumber(int idx) {
		if (generationalGenerationNumbers == null || idx >= generationalGenerationNumbers.size()) {
			return idx;
		}
		return generationalGenerationNumbers.get(idx);
	}

	public List<Integer> getGenerationalTaskIndices(int idx) {
		if (generationalTaskIndices == null || idx >= generationalTaskIndices.size()) {
			List<Integer> unknownTasks = new ArrayList<>();
			for (int i = 0; i < generationalParetoFrontRules.get(idx).size(); i++) {
				unknownTasks.add(-1);
			}
			return unknownTasks;
		}
		return generationalTaskIndices.get(idx);
	}

	public int getGenerationalTaskIndex(int generationIdx, int individualIdx) {
		List<Integer> taskIndices = getGenerationalTaskIndices(generationIdx);
		if (individualIdx >= taskIndices.size()) {
			return -1;
		}
		return taskIndices.get(individualIdx);
	}
	...
	public void addGenerationalTestEnsembleContribution(List<List<Double>> testEnsembleContribution) {
...
//=========================================================================
	...
	public void addGenerationalGenerationNumber(int generation) {
		this.generationalGenerationNumbers.add(generation);
	}

	public void addGenerationalTaskIndices(List<Integer> taskIndices) {
		this.generationalTaskIndices.add(taskIndices);
	}
	...
	public static ParetoSetLearningParetoFrontTestResult readFromFile(File file, RuleTypeV2 ruleType, int numPopulations, int numPreference) {
		return ParetoSetLearningMultipleTreeResultFileReader.readParetoSetLearningParetoFrontForGenerationFromFile(file, ruleType, ruleType.isMultiobjective(), numPopulations, numPreference);
	}
