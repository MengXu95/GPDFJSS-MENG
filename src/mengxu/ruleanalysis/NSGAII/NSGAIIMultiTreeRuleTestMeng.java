...
public class NSGAIIMultiTreeRuleTestMeng {
	 ...
	 public static final long simSeed = 968356;
	    ...
	    public NSGAIIMultiTreeRuleTestMeng(String trainPath, RuleTypeV2 ruleType, int numRuns,
...
//				TestResult result = NSGAIIMultipleTreeTestResult.readParetoFrontFromFile(sourceFile, ruleType, numTrees);
				...
				for (int j = 0; j < result.getGenerationalParetoFrontRules().size(); j++) {
					if(j == result.getGenerationalParetoFrontRules().size()-1){
						...
						if(j*5 == 40){
							System.out.println("error here! need debug!");
						}
					}
...
//                              testFit.getObjective(k));
		...
		public static void main(String[] args) {
			...
			NSGAIIMultiTreeRuleTestMeng multipletreeruleTest = new NSGAIIMultiTreeRuleTestMeng(trainPath, ruleType, numRuns, testScenario, testSetName, numTrees);
