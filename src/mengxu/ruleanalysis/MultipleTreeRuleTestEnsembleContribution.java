...
public class MultipleTreeRuleTestEnsembleContribution {
	 ...
	 public static final long simSeed = 968356;
	    ...
	    public MultipleTreeRuleTestEnsembleContribution(String trainPath, RuleTypeV2 ruleType, int indexOfRun,
...
//						"EditOneDiversity,EditTwoDiversity,PCDiversity");
				...
				writer.write("Run,Generation,SeqRuleSize,SeqRuleUniqueTerminals,RoutRuleSize," +
						"RoutRuleUniqueTerminals,Obj,IndividualWin,finalTrainFitness,TrainFitness,FinalTestFitness,TestFitness,TrainTime," +
						"TrainEnsembleContribution, TestEnsembleContribution, GenotypeDiversity,PhenotypeDiversity,EntropyDiversity,PseudoIsomorphsDiversity," +
						"EditOneDiversity,EditTwoDiversity,PCDiversity");
	            writer.newLine();
							...
							for(int e=0; e<sequencingRules.size(); e++){
								...
								if (objectives.size() == 1) {
									writer.write(i + "," + j + "," +
											...
											finalTestFit.fitness() + "," +
											eachTestFit.get(e).fitness() + "," +
//											"0," +
											result.getGenerationalTime(j) + "," +
											trainEnsembleContribution.get(e) + "," +
											testEnsembleContribution.get(e) + "," +
											genotypeDiversity + "," +
											phenotypeDiversity + "," +
											entropyDiversity + "," +
											pseudoIsomoDiversity + "," +
...
//	            }
		...
		public static void main(String[] args) {
			...
			MultipleTreeRuleTestEnsembleContribution multipletreeruleTest = new MultipleTreeRuleTestEnsembleContribution(trainPath, ruleType, indexofRun, testScenario, testSetName, numTrees);
