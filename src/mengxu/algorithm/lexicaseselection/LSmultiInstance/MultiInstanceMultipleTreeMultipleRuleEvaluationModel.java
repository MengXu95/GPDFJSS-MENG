...
public class MultiInstanceMultipleTreeMultipleRuleEvaluationModel extends MultipleTreeMultipleRuleEvaluationModel {
...
//            Parameter b = base.push(P_SIM_MODELS).push("" + x);
            Parameter b = base.push(P_SIM_MODELS).push("" + 0); //modified by mengxu 2022.03.10
            // Number of machines
...
//        double[] fitnesses = new double[objectives.size()];
        ...
        int col = 0;
        double[][] fitnesses = new double[simulations.size()][objectives.size()];//modified by mengxu
...
//        }
        ...
        for (Fitness fitness: currentFitnesses) {
            MultiInstanceMultiObjectiveFitness f = (MultiInstanceMultiObjectiveFitness) fitness;
...
//        double[] fitnesses = new double[objectives.size()];
        ...
        double[] multiCaseObjValue = new double[numInstance];
