...
public class OneInstanceMultiCaseMultipleTreeMultipleRuleEvaluationModelImproved extends MultipleTreeMultipleRuleEvaluationModel {
...
//        double[] fitnesses = new double[objectives.size()];
        ...
        int col = 0;
        double[][] fitnesses = new double[numCase+1][objectives.size()];//modified by mengxu 2021.11.22 in order to add the whole fitness
...
//                fitnesses[i] += normObjValue;  //the value of fitness is the normalization of the objective value
                ...
                //add by mengxu 2021.11.22
                fitnesses[numCase][i] += simulation.objectiveValueMultiCaseWhole(objectives.get(i),numCase);
...
//        System.out.println();
        ...
        for (Fitness fitness: currentFitnesses) {
            MultiInstanceMultiObjectiveFitnessImproved f = (MultiInstanceMultiObjectiveFitnessImproved) fitness;
...
//        double[] fitnesses = new double[objectives.size()];
        ...
        List<Simulation> simulations = schedulingSet.getSimulations();
        int col = 0;
        double[][] fitnesses = new double[numCase+1][objectives.size()];//modified by mengxu 2021.11.22
