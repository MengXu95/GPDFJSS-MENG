...
public class AverageMultiCaseMultipleTreeMultipleRuleEvaluationModel extends MultipleTreeMultipleRuleEvaluationModel {
...
//        System.out.println();
        ...
        for (Fitness fitness: currentFitnesses) {
            AverageMultiCaseMultiObjectiveFitness f = (AverageMultiCaseMultiObjectiveFitness) fitness;
            f.setMultiCaseFitness(state, fitnesses);
