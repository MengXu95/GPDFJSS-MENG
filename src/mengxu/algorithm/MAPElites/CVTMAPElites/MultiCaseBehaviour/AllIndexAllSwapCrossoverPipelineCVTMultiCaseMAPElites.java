 ...
 */
public class AllIndexAllSwapCrossoverPipelineCVTMultiCaseMAPElites extends CrossoverPipeline {
    /**
...
//                sources[1].produce(1,1,1,subpopulation,parents,state,thread);
            ...
            if(parent0 == null){
                parent0 = (GPIndividual) ((GPRuleEvolutionStateCVTMultiCaseMAPElites)state).parentsForCrossover[0];
            }
            if(parent1 == null){
                parent1 = (GPIndividual) ((GPRuleEvolutionStateCVTMultiCaseMAPElites)state).parentsForCrossover[1];
            }
          ...
          //  System.out.println(parents[1].trees.length);
            ...
            inds[q] = j1;
                if(((GPRuleEvolutionStateCVTMultiCaseMAPElites)state).use_CVT_map && ((GPRuleEvolutionStateCVTMultiCaseMAPElites)state).CVTMapUpdateImmediate){//2023.09.25 by mengxu
                    this.IndividualFitnessEvaluation(state, j1);
                }
            q++;
            ...
            if (q<n+start && !tossSecondParent)
                ...
                inds[q] = j2;
                    if(((GPRuleEvolutionStateCVTMultiCaseMAPElites)state).use_CVT_map && ((GPRuleEvolutionStateCVTMultiCaseMAPElites)state).CVTMapUpdateImmediate){//2023.09.25 by mengxu
                        this.IndividualFitnessEvaluation(state, j2);
                    }
                q++;
                }
            }
...
//            double[] indCharListsMultiTree = calculateIndividualMultiCaseFitness(state,individual,true);
