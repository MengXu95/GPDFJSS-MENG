 ...
 */
public class AllIndexAllSwapCrossoverPipelineCVTMAPElites extends CrossoverPipeline {
    /**
...
//                sources[1].produce(1,1,1,subpopulation,parents,state,thread);
            ...
            if(parent0 == null){
                parent0 = (GPIndividual) ((GPRuleEvolutionStateCVTMAPElites)state).parentsForCrossover[0];
            }
            if(parent1 == null){
                parent1 = (GPIndividual) ((GPRuleEvolutionStateCVTMAPElites)state).parentsForCrossover[1];
            }
