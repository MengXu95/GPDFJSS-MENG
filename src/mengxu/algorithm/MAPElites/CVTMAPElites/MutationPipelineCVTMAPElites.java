...
public class MutationPipelineCVTMAPElites extends GPBreedingPipeline
    {
    ...
    public Object clone()
        {
        MutationPipelineCVTMAPElites c = (MutationPipelineCVTMAPElites)(super.clone());
    ...
    public int produce(final int min,
        ...
        for(int q=start; q < n+start; q++) //q=start = 0  q<1
            ...
            if(i == null){
                i = (GPIndividual) ((GPRuleEvolutionStateCVTMAPElites)state).parentsForMutation;
            }
...
//                }
            ...
            //original
            inds[q] = j;
                if(((GPRuleEvolutionStateCVTMAPElites)state).use_CVT_map && ((GPRuleEvolutionStateCVTMAPElites)state).CVTMapUpdateImmediate){//2023.09.25 by mengxu
        ...
        public void IndividualFitnessEvaluation(EvolutionState state, Individual individual){
            ...
            if (((GPRuleEvolutionStateCVTMAPElites)state).CVTMapUpdateImmediate && ((GPRuleEvolutionStateCVTMAPElites)state).usingManuralRuleNormalisation) {
