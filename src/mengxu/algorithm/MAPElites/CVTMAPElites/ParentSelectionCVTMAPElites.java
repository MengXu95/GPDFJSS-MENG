...
public class ParentSelectionCVTMAPElites extends TournamentSelection implements SteadyStateBSourceForm
    {
    /** default base */
    ...
    public int produce(final int subpopulation,
        ...
        if(((GPRuleEvolutionStateCVTMAPElites)state).use_CVT_map && ((GPRuleEvolutionStateCVTMAPElites)state).parentsFromCVTMapAndPop){
...
//        System.out.println("tournament size: " + s);
            ...
            if(((GPRuleEvolutionStateCVTMAPElites)state).tournamentSizeDynamic){
