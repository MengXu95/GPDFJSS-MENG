...
public class MutationPipelineGridMAPElites extends GPBreedingPipeline
    {
    ...
    public Object clone()
        {
        MutationPipelineGridMAPElites c = (MutationPipelineGridMAPElites)(super.clone());
    ...
    public int produce(final int min,
        ...
        for(int q=start; q < n+start; q++) //q=start = 0  q<1
            ...
            if(i == null){
                i = (GPIndividual) ((GPRuleEvolutionStateGridMAPElites)state).parentsForMutation;
            }
            ...
            inds[q] = j;
                if(((GPRuleEvolutionStateGridMAPElites)state).use_grid_map && ((GPRuleEvolutionStateGridMAPElites)state).mapUpdateImmediate){//2023.09.25 by mengxu
                    ((GPRuleEvolutionStateGridMAPElites)state).IndividualFitnessEvaluation(state, j);
                }
            }
        return n;
        }
