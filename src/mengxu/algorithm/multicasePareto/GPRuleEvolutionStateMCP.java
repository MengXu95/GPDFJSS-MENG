...
public class GPRuleEvolutionStateMCP extends GPRuleEvolutionState {
...
//		poorCasesForGen = calculateTheFocusdPoorCases(individuals, 400);
		...
		System.out.println("Best ind fitness: "+ individuals[0].fitness.fitness());
...
//		System.out.println("]");
	...
	public void writeMultiCaseFitnessOfTop400IndividualToFile(Individual[] individuals, int numTop){
		PopulationUtils.sort(individuals);
		OneInstanceMultiCaseFitnessNSGAII fitness = (OneInstanceMultiCaseFitnessNSGAII)individuals[0].fitness;
		...
		try {
			...
			for(int ind=0; ind<400 && ind<individuals.length; ind++){
				fitness = (OneInstanceMultiCaseFitnessNSGAII)individuals[ind].fitness;
