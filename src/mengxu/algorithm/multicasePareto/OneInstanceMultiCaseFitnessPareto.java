...
public class OneInstanceMultiCaseFitnessPareto extends OneInstanceMultiCaseMultiObjectiveFitness {
...
//        return s + FITNESS_POSTAMBLE;
    ...
    {
        OneInstanceMultiCaseFitnessPareto other = (OneInstanceMultiCaseFitnessPareto) _fitness;
...
//        boolean bbeatsa = false;
    ...
    {
        return paretoDominates((OneInstanceMultiCaseFitnessPareto)fitness);
    }
    ...
    public boolean paretoDominates(OneInstanceMultiCaseFitnessPareto other)
    {
    ...
    public boolean betterThanOnPoorCases(EvolutionState state, Fitness fitness)
    {
        ...
        switch (objective) {
            ...
            case MEAN_TARDINESS:
            case MEAN_WEIGHTED_TARDINESS:
                return compareInstanceV2meanOnPoorCases(state, (OneInstanceMultiCaseFitnessPareto)fitness);
            case MAX_FLOWTIME:
            case MAX_WEIGHTED_FLOWTIME:
            case MAX_TARDINESS:
            case MAX_WEIGHTED_TARDINESS:
                return compareInstanceV2maxOnPoorCases(state, (OneInstanceMultiCaseFitnessPareto)fitness);
        }
        System.out.println("Error, MultiInstanceMultiObjectiveFitness.betterThan()");

        return compareInstanceV2mean((OneInstanceMultiCaseFitnessPareto)fitness);
    }

    //add 2021.12.27
    public boolean betterThanBasedOnBinaryBring(Fitness fitness){
        double[][] otherBinaryBring = ((OneInstanceMultiCaseFitnessPareto)fitness).getMultiInstanceMultiObjectiveBinaryBring();
        double advantage0 = 0;
        double advantage1 = 0;
    ...
    public boolean betterThanBasedOnNormalisation(Fitness fitness){
        double[][] otherNormalisation = ((OneInstanceMultiCaseFitnessPareto)fitness).getMultiInstanceMultiObjectiveNormalisation();
        double advantage0 = 0;
        double advantage1 = 0;
    ...
    public boolean compareInstanceV1(OneInstanceMultiCaseFitnessPareto other)
    {
        boolean abeatsb = false;
    ...
    public boolean compareInstanceV2mean(OneInstanceMultiCaseFitnessPareto other)
    {
        boolean abeatsb = false;
    ...
    public boolean compareInstanceV2meanOnPoorCases(EvolutionState state, OneInstanceMultiCaseFitnessPareto other)
    {
        boolean abeatsb = false;
    ...
    public boolean compareInstanceV2max(OneInstanceMultiCaseFitnessPareto other)
    {
        boolean abeatsb = false;
    ...
    public boolean compareInstanceV2maxOnPoorCases(EvolutionState state, OneInstanceMultiCaseFitnessPareto other)
    {
        boolean abeatsb = false;
