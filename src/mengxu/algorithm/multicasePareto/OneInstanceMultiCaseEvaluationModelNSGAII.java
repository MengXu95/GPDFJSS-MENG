...
public class OneInstanceMultiCaseEvaluationModelNSGAII extends MultipleTreeMultipleRuleEvaluationModel {
...
//        System.out.println();
        ...
        for (Fitness fitness: currentFitnesses) {
            OneInstanceMultiCaseFitnessNSGAII f = (OneInstanceMultiCaseFitnessNSGAII) fitness;
