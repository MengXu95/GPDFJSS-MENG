...
public class SimpleStatisticsSaveRulesizeGeneGP extends SimpleStatisticsSaveRulesizeGen {
    ...
    public void preEvaluationStatistics(final EvolutionState state)
        ...
        //fzhang 15.6.2018  in order to check the average size of sequencing and routing rules in population
			...
			List<EnsembleRule> ensemblePool = ((EnsembleEvaluatoreGP)state.evaluator).ensemblePool;
	...
	public void postEvaluationStatistics(final EvolutionState state)
	{
		...
		List<EnsembleRule> ensembleRuleList = ((EnsembleEvaluatoreGP)state.evaluator).ensemblePool;
