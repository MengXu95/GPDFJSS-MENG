...
public class GPRuleEvolutionStateClusterV1 extends GPRuleEvolutionState {
...
//		System.out.println("ParentIndex diversity: " + parentIndexDvalue);
		...
		double[][] indsCharListsMultiTree300 = Arrays.copyOfRange(indsCharListsMultiTree[0],  0 ,  300 );
		double[] fitnessesForModel300 = Arrays.copyOfRange(fitnessesForModel[0],  0 ,  300);
		System.out.println("length: " + fitnessesForModel300.length);
		//this is suitable for only one subpop
		List<CustomerPoint> customerPoints = buildCustomerPoint(indsCharListsMultiTree300, fitnessesForModel300);
