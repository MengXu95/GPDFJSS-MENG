...
public class SimpleStatisticsSaveRulesizeGenMultiTaskLearningSVROneSubpop extends SimpleStatisticsSaveRulesizeGen {
...
//		}
		...
		{//todo: x should start from 1 or 0??? 2024.10.29
			...
			for(int i=0; i<inds.length; i++){
				if(((MultiObjectiveFitnessMultiTaskLearningSVROneSubpop)inds[i].fitness).betterThanBasedOnRelationshipModel(i, subpopIndex_best, state, 0)){
