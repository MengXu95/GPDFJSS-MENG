...
public class GPRuleEvolutionStateMultiTaskLearningSurrogateSVR extends GPRuleEvolutionState {
	...
	public double[][][][] PCOnAllTasks = null;
...
//		System.out.println("Edit 2 diversity: " + edit2Dvalue);
		...
		Problem[] problems =((MultitaskEvaluatorSurrogateSVR)evaluator).multiproblems;
