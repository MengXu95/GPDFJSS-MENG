...
public class MultiObjectiveFitnessMultiTaskLearningOnlySurrogate extends MultiObjectiveFitness
    {
...
//                }
  ...
  /*    0.798331424977548
    ...
    public Object clone()
        {
        MultiObjectiveFitnessMultiTaskLearningOnlySurrogate f = (MultiObjectiveFitnessMultiTaskLearningOnlySurrogate) (super.clone());
    ...
    public boolean equivalentTo(Fitness _fitness)
        {
        MultiObjectiveFitnessMultiTaskLearningOnlySurrogate other = (MultiObjectiveFitnessMultiTaskLearningOnlySurrogate) _fitness;
    ...
    public boolean betterThan(Fitness fitness)
        {
        return paretoDominates((MultiObjectiveFitnessMultiTaskLearningOnlySurrogate)fitness);
        }

        public boolean betterThanBasedOnSurrogate(int index_first, Individual first,
                                                  int index_second, Individual second,
                                                  int subpop_first, int subpop_second, EvolutionState state, int thread) {
            boolean fitnessBasedOnRank = ((MultitaskEvaluatorOnlySurrogate)state.evaluator).fitnessBasedOnRank;
        ...
        public boolean betterThanBasedOnEstimatedFitness(int index_first, Individual first,
                                                                int index_second, Individual second,
                                                                int subpop_first, int subpop_second, EvolutionState state, int thread) {
            double[][][] estimatedFitness = ((MultitaskEvaluatorOnlySurrogate) ((GPRuleEvolutionStateMultiTaskLearningOnlySurrogate) state).evaluator).estimatedFitness;
            double[] lowerbound = ((MultitaskEvaluatorOnlySurrogate) ((GPRuleEvolutionStateMultiTaskLearningOnlySurrogate) state).evaluator).lowerBound;
        ...
        public boolean betterThanBasedOnEstimatedFitness_Normalise(int index_first, Individual first,
            ...
            boolean average_weight = ((GPRuleEvolutionStateMultiTaskLearningOnlySurrogate) state).average_weight;
            double main_task_weight = ((GPRuleEvolutionStateMultiTaskLearningOnlySurrogate) state).main_task_weight;
            if(average_weight){
            ...
            double fit_second = second.fitness.fitness() / lowerbound[subpop_second];
        ...
        public boolean betterThanBasedOnEstimatedRank(int index_first, Individual first,
                                                             int index_second, Individual second,
                                                             int subpop_first, int subpop_second, EvolutionState state, int thread) {
            double[][][] estimatedRank = ((MultitaskEvaluatorOnlySurrogate) ((GPRuleEvolutionStateMultiTaskLearningOnlySurrogate) state).evaluator).estimatedRank;
    ...
    public boolean paretoDominates(MultiObjectiveFitnessMultiTaskLearningOnlySurrogate other)
        {
        boolean abeatsb = false;
    ...
    public static ArrayList partitionIntoParetoFront(Individual[] inds, ArrayList front, ArrayList nonFront)
        ...
        for (int i = 1; i < inds.length; i++)
            ...
            for (int j = 0; j < frontSize; j++)
                ...
                if (((MultiObjectiveFitnessMultiTaskLearningOnlySurrogate) (frontmember.fitness)).paretoDominates((MultiObjectiveFitnessMultiTaskLearningOnlySurrogate) (ind.fitness)))
                    {
                ...
                else if (((MultiObjectiveFitnessMultiTaskLearningOnlySurrogate) (ind.fitness)).paretoDominates((MultiObjectiveFitnessMultiTaskLearningOnlySurrogate) (frontmember.fitness)))
                    {
                    yank(j, front);
    ...
    public static ArrayList partitionIntoRanks(Individual[] inds)
        ...
        while(inds.length > 0) //the dominated individuals
            ...
            MultiObjectiveFitnessMultiTaskLearningOnlySurrogate.partitionIntoParetoFront(inds, front, nonFront); //after this, the individuals are divided into two groups: front and nonfront
    ...
    public double sumSquaredObjectiveDistance(MultiObjectiveFitnessMultiTaskLearningOnlySurrogate other)
        {
        double s = 0;
     ...
     */
    public double manhattanObjectiveDistance(MultiObjectiveFitnessMultiTaskLearningOnlySurrogate other)
        {
        double s = 0;
        for (int i = 0; i < objectives.length; i++)
            {
    ...
    public void setToMeanOf(EvolutionState state, Fitness[] fitnesses)
        ...
        for(int i = 0; i < objectives.length; i++)
            ...
            for(int k = 0; k < fitnesses.length; k++)
                {
                MultiObjectiveFitnessMultiTaskLearningOnlySurrogate f = (MultiObjectiveFitnessMultiTaskLearningOnlySurrogate) fitnesses[k];
                sum += f.objectives[i];
                }
