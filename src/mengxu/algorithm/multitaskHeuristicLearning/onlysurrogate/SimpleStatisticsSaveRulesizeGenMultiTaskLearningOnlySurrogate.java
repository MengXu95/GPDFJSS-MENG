...
public class SimpleStatisticsSaveRulesizeGenMultiTaskLearningOnlySurrogate extends SimpleStatisticsSaveRulesizeGen {
...
//		}
		...
		for(int x=1;x<state.population.subpops.length;x++)
		{
			...
			if(((MultiObjectiveFitnessMultiTaskLearningOnlySurrogate)best_i[x].fitness).betterThanBasedOnSurrogate(subpopIndex_j, ind_j, subpopIndex_best, best_allSubpop, subpop_j, subpop_best, state, 0)){
...
//				if(((MultiObjectiveFitnessMultiTaskLearningOnlySurrogate)inds[i].fitness).betterThanBasedOnSurrogate(subpopIndex_j, ind_j, subpopIndex_best, best_allSubpop, subpop_j, subpop_best, state, 0)){
