...
public class SimpleStatisticsSaveRulesizeDivNich extends SimpleStatisticsSaveRulesizeGen {
...
//			}
			...
			if (doGeneration && !((GPRuleEvolutionStateDivNich) state).printEnsemble) {
...
//
//				EnsembleRule bestEnsemble = ((GPRuleEvolutionStateDivNich)state).ensembleRule;
//				state.output.println("Ensemble win with " + bestEnsemble.getFitness().fitnessToStringForHumans(),statisticslog);
//				bestEnsemble.printEnsembleContribution(state, statisticslog);
//
//				for(int e=0; e<bestEnsemble.getEnsembleSize(); e++){
//					bestEnsemble.getEnsemble().get(e).printIndividualForHumans(state,statisticslog);
//				}
//			}
			else if (doGeneration && ((GPRuleEvolutionStateDivNich) state).printEnsemble){//added by mengxu for bagGP output
//				state.output.println("Ensemble win with Fitness: [-1]",statisticslog);
//				state.output.println("Ensemble contribution: [-1, -1, -1, -1, -1]",statisticslog);
