...
public class OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution extends OneInstanceMultiCaseMultiObjectiveFitness {
...
//        System.out.println();
    ...
    public void fitnessClear(){
        for(int i=0; i<this.multiInstanceMultiObjectiveFitness.length; i++){
            for(int j=0; j<this.multiInstanceMultiObjectiveFitness[i].length; j++){
                this.multiInstanceMultiObjectiveFitness[i][j] = Double.POSITIVE_INFINITY;
            }
        }
    }
...
//        return s + FITNESS_POSTAMBLE;
    ...
    {
        OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution other = (OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution) _fitness;
...
//                    return true;
    ...
    public boolean betterThan(Fitness fitness)
    {
        ...
        switch (objective) {
            ...
            case MEAN_TARDINESS:
            case MEAN_WEIGHTED_TARDINESS:
                return compareInstanceV2mean((OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution)fitness);
            case MAX_FLOWTIME:
            case MAX_WEIGHTED_FLOWTIME:
            case MAX_TARDINESS:
            case MAX_WEIGHTED_TARDINESS:
                return compareInstanceV2max((OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution)fitness);
        }
        System.out.println("Error, MultiInstanceMultiObjectiveFitness.betterThan()");
    ...
    public boolean betterThanOnPoorCases(EvolutionState state, Fitness fitness)
    {
        ...
        switch (objective) {
            ...
            case MEAN_TARDINESS:
            case MEAN_WEIGHTED_TARDINESS:
                return compareInstanceV2meanOnPoorCases(state, (OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution)fitness);
            case MAX_FLOWTIME:
            case MAX_WEIGHTED_FLOWTIME:
            case MAX_TARDINESS:
            case MAX_WEIGHTED_TARDINESS:
                return compareInstanceV2maxOnPoorCases(state, (OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution)fitness);
        }
        System.out.println("Error, MultiInstanceMultiObjectiveFitness.betterThan()");
    ...
    public boolean betterThanBasedOnBinaryBring(Fitness fitness){
        double[][] otherBinaryBring = ((OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution)fitness).getMultiInstanceMultiObjectiveBinaryBring();
        double advantage0 = 0;
        double advantage1 = 0;
    ...
    public boolean betterThanBasedOnNormalisation(Fitness fitness){
        double[][] otherNormalisation = ((OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution)fitness).getMultiInstanceMultiObjectiveNormalisation();
        double advantage0 = 0;
        double advantage1 = 0;
    ...
    public boolean compareInstanceV1(OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution other)
    {
    ...
    public boolean compareInstanceV2mean(OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution other)
    {
        boolean abeatsb = false;
    ...
    public boolean compareInstanceV2meanOnPoorCases(EvolutionState state, OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution other)
    {
        boolean abeatsb = false;
    ...
    public boolean compareInstanceV2max(OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution other)
    {
        boolean abeatsb = false;
    ...
    public boolean compareInstanceV2maxOnPoorCases(EvolutionState state, OneInstanceMultiCaseMultiObjectiveFitnessEnsembleContribution other)
    {
        boolean abeatsb = false;
