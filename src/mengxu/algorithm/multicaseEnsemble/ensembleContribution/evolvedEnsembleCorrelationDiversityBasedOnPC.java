...
public class evolvedEnsembleCorrelationDiversityBasedOnPC {
    ...
    public evolvedEnsembleCorrelationDiversityBasedOnPC(String trainPath, RuleTypeV2 ruleType, int indexOfRun,
    ...
    public double calculateEntropyDiversity(){
        ...
        File csvFile = new File(targetPath + "/" + testSetName + "_correlationDiversityPC_" + indexOfRun + ".csv"); //create a .csv to save the test result
        ...
        try {
            ...
            for (int j = 0; j < result.getGenerationalRules().size() && j<=51; j++) {
                ...
                if(result.getGenerationalRules(j) != null){// single individual win
                    double correlationDvalue = 0;
                    writer.write(i + "," + j + "," + correlationDvalue);
                    writer.newLine();
//                    continue;
...
//        idx ++;
        ...
        String algo = "EGP-LFS-V-pro3-40-5";
        ...
        evolvedEnsembleCorrelationDiversityBasedOnPC multipletreeruleTest1 = new evolvedEnsembleCorrelationDiversityBasedOnPC(trainPath1, ruleType1, indexofRun1, testScenario1, testSetName1, numTrees1);
...
//            idx ++;
        ...
        evolvedEnsembleCorrelationDiversityBasedOnPC multipletreeruleTest2 = new evolvedEnsembleCorrelationDiversityBasedOnPC(trainPath2, ruleType2, indexofRun2, testScenario2, testSetName2, numTrees2);
...
//            idx ++;
        ...
        //
        String  trainPath3 = "/home/xume/Desktop/" + algo + "/multipletreegp-dynamic/max-tardiness-0.85-1.5/";
        ...
        evolvedEnsembleCorrelationDiversityBasedOnPC multipletreeruleTest3 = new evolvedEnsembleCorrelationDiversityBasedOnPC(trainPath3, ruleType3, indexofRun3, testScenario3, testSetName3, numTrees3);
...
//            idx ++;
        ...
        //
        String  trainPath4 = "/home/xume/Desktop/" + algo + "/multipletreegp-dynamic/max-tardiness-0.95-1.5/";
        ...
        evolvedEnsembleCorrelationDiversityBasedOnPC multipletreeruleTest4 = new evolvedEnsembleCorrelationDiversityBasedOnPC(trainPath4, ruleType4, indexofRun4, testScenario4, testSetName4, numTrees4);
...
//            idx ++;
        ...
        //
        String  trainPath5 = "/home/xume/Desktop/" + algo + "/multipletreegp-dynamic/mean-weighted-tardiness-0.85-1.5/";
        ...
        evolvedEnsembleCorrelationDiversityBasedOnPC multipletreeruleTest5 = new evolvedEnsembleCorrelationDiversityBasedOnPC(trainPath5, ruleType5, indexofRun5, testScenario5, testSetName5, numTrees5);
...
//            idx ++;
        ...
        //
        String  trainPath6 = "/home/xume/Desktop/" + algo + "/multipletreegp-dynamic/mean-weighted-tardiness-0.95-1.5/";
        ...
        evolvedEnsembleCorrelationDiversityBasedOnPC multipletreeruleTest6 = new evolvedEnsembleCorrelationDiversityBasedOnPC(trainPath6, ruleType6, indexofRun6, testScenario6, testSetName6, numTrees6);
