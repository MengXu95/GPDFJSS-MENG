...
public class SimpleStatisticsSaveRulesizeEnsembleGen extends SimpleStatisticsSaveRulesizeGen {
	...
	public void postEvaluationStatistics(final EvolutionState state)
	{
		...
		for(int x=0;x<state.population.subpops.length;x++)
		{
			...
			if (doGeneration && bestIdEnsemble == -1) {
			...
			if (doGeneration && bestIdEnsemble != -1){
				EnsembleRule bestEnsemble = ensemblePool.get(bestIdEnsemble);
