...
public class evolvedEnsembleSpreadOfDecisions {
    ...
    public evolvedEnsembleSpreadOfDecisions(String trainPath, RuleTypeV2 ruleType, int indexOfRun,
    ...
    public double calculateEnsembleSpread(){
        ...
        File csvFile = new File(targetPath + "/" + testSetName + "_ensembleSpread_allGen_" + indexOfRun + ".csv"); //create a .csv to save the test result

        int i = indexOfRun;
        System.out.println("Run "+ i);
        File sourceFile = new File(trainPath + "job." + i + ".out.stat");  //this file keeps the rule
        TestResult result = MultipleTreeTestResult.readEnsembleContributionAndSpreadFromFile(sourceFile, ruleType, numTrees);

        long start = System.currentTimeMillis();

        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter(csvFile.getAbsoluteFile()));
            writer.write("Run,Generation,EnsembleSpread");
            writer.newLine();

            for (int j = 0; j < result.getGenerationalRules().size() && j<=50; j++) {
...
//                    continue;
    ...
    //                        result.getGenerationalTestFitness(j).fitness());
                    ...
                    if (numTrees == 2) {
                        ...
                        testSet.getSimulations().get(0).useLS = false;
                        generationalEnsembleRules.calcFitnessAndSpreadByVotingEnsemble(  //this is to get the final fitness by the voting of ensemble
                        ...
                        double[] testEnsembleSpread = generationalEnsembleRules.getEnsembleSpread();
                        for(int c=0; c< testEnsembleContribution.length; c++){
                            ...
                            result.getGenerationalTestEnsembleSpread().get(j).add(testEnsembleSpread[c]);
                        }

                        System.out.println("Generation " + j + ": ensemble test fitness = " +
                                result.getGenerationalEnsembleTestFitnesses().get(j).fitness());

                        for(int e=0; e<testEnsembleSpread.length; e++){
                            writer.write(i + "," + j + "," + testEnsembleSpread[e]);
                            writer.newLine();

                            System.out.println("Generation " + j + ": ensemble " + e + " spread = " + testEnsembleSpread[e]);
                        }
...
//        idx ++;
        ...
        String  trainPath1 = "/home/xume/Desktop/EGP-TI-V-40-5/multipletreegp-dynamic/max-flowtime-0.85-1.5/";
        ...
        evolvedEnsembleSpreadOfDecisions multipletreeruleTest1 = new evolvedEnsembleSpreadOfDecisions(trainPath1, ruleType1, indexofRun1, testScenario1, testSetName1, numTrees1);
...
//            idx ++;
        ...
        for(int i=0;i<30;i++){
            ...
            double diversity = multipletreeruleTest1.calculateEnsembleSpread();
            if(diversity != 0){
        ...
        //
        String  trainPath2 = "/home/xume/Desktop/EGP-TI-V-40-5/multipletreegp-dynamic/max-flowtime-0.95-1.5/";
        ...
        evolvedEnsembleSpreadOfDecisions multipletreeruleTest2 = new evolvedEnsembleSpreadOfDecisions(trainPath2, ruleType2, indexofRun2, testScenario2, testSetName2, numTrees2);
...
//            idx ++;
        ...
        for(int i=0;i<30;i++){
            ...
            double diversity = multipletreeruleTest2.calculateEnsembleSpread();
            if(diversity != 0){
        ...
        //
        String  trainPath3 = "/home/xume/Desktop/EGP-TI-V-40-5/multipletreegp-dynamic/max-tardiness-0.85-1.5/";
        ...
        evolvedEnsembleSpreadOfDecisions multipletreeruleTest3 = new evolvedEnsembleSpreadOfDecisions(trainPath3, ruleType3, indexofRun3, testScenario3, testSetName3, numTrees3);
...
//            idx ++;
        ...
        for(int i=0;i<30;i++){
            ...
            double diversity = multipletreeruleTest3.calculateEnsembleSpread();
            if(diversity != 0){
        ...
        //
        String  trainPath4 = "/home/xume/Desktop/EGP-TI-V-40-5/multipletreegp-dynamic/max-tardiness-0.95-1.5/";
        ...
        evolvedEnsembleSpreadOfDecisions multipletreeruleTest4 = new evolvedEnsembleSpreadOfDecisions(trainPath4, ruleType4, indexofRun4, testScenario4, testSetName4, numTrees4);
...
//            idx ++;
        ...
        for(int i=0;i<30;i++){
            ...
            double diversity = multipletreeruleTest4.calculateEnsembleSpread();
            if(diversity != 0){
        ...
        //
        String  trainPath5 = "/home/xume/Desktop/EGP-TI-V-40-5/multipletreegp-dynamic/mean-weighted-tardiness-0.85-1.5/";
        ...
        evolvedEnsembleSpreadOfDecisions multipletreeruleTest5 = new evolvedEnsembleSpreadOfDecisions(trainPath5, ruleType5, indexofRun5, testScenario5, testSetName5, numTrees5);
...
//            idx ++;
        ...
        for(int i=0;i<30;i++){
            ...
            double diversity = multipletreeruleTest5.calculateEnsembleSpread();
            if(diversity != 0){
        ...
        //
        String  trainPath6 = "/home/xume/Desktop/EGP-TI-V-40-5/multipletreegp-dynamic/mean-weighted-tardiness-0.95-1.5/";
        ...
        evolvedEnsembleSpreadOfDecisions multipletreeruleTest6 = new evolvedEnsembleSpreadOfDecisions(trainPath6, ruleType6, indexofRun6, testScenario6, testSetName6, numTrees6);
...
//            idx ++;
        ...
        for(int i=0;i<30;i++){
            ...
            double diversity = multipletreeruleTest6.calculateEnsembleSpread();
            if(diversity != 0){
