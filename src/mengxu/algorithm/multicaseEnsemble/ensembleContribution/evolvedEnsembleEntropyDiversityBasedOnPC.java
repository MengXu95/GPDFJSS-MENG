...
public class evolvedEnsembleEntropyDiversityBasedOnPC {
    ...
    public evolvedEnsembleEntropyDiversityBasedOnPC(String trainPath, RuleTypeV2 ruleType, int indexOfRun,
    ...
    public double calculateEntropyDiversity(){
        ...
        File csvFile = new File(targetPath + "/" + testSetName + "_entropyDiversityPC_" + indexOfRun + ".csv"); //create a .csv to save the test result
        ...
        try {
            ...
            for (int j = 0; j < result.getGenerationalRules().size() && j<=51; j++) {
                ...
                if(result.getGenerationalRules(j) != null){// single individual win
                    double entropy = -1 * Math.log(1);
                    writer.write(i + "," + j + "," + entropy);
                    writer.newLine();
//                    continue;
...
//                                    testSet, routingRule, objectives);
                    ...
                    double entroDvalue = PopulationUtils.entropy(indsCharListsMultiTree0);
...
//        idx ++;
        ...
        evolvedEnsembleEntropyDiversityBasedOnPC multipletreeruleTest1 = new evolvedEnsembleEntropyDiversityBasedOnPC(trainPath1, ruleType1, indexofRun1, testScenario1, testSetName1, numTrees1);
...
//            idx ++;
        ...
        evolvedEnsembleEntropyDiversityBasedOnPC multipletreeruleTest2 = new evolvedEnsembleEntropyDiversityBasedOnPC(trainPath2, ruleType2, indexofRun2, testScenario2, testSetName2, numTrees2);
...
//            idx ++;
        ...
        evolvedEnsembleEntropyDiversityBasedOnPC multipletreeruleTest3 = new evolvedEnsembleEntropyDiversityBasedOnPC(trainPath3, ruleType3, indexofRun3, testScenario3, testSetName3, numTrees3);
...
//            idx ++;
        ...
        evolvedEnsembleEntropyDiversityBasedOnPC multipletreeruleTest4 = new evolvedEnsembleEntropyDiversityBasedOnPC(trainPath4, ruleType4, indexofRun4, testScenario4, testSetName4, numTrees4);
...
//            idx ++;
        ...
        evolvedEnsembleEntropyDiversityBasedOnPC multipletreeruleTest5 = new evolvedEnsembleEntropyDiversityBasedOnPC(trainPath5, ruleType5, indexofRun5, testScenario5, testSetName5, numTrees5);
...
//            idx ++;
        ...
        evolvedEnsembleEntropyDiversityBasedOnPC multipletreeruleTest6 = new evolvedEnsembleEntropyDiversityBasedOnPC(trainPath6, ruleType6, indexofRun6, testScenario6, testSetName6, numTrees6);
