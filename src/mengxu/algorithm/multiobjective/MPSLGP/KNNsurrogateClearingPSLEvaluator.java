...
public class KNNsurrogateClearingPSLEvaluator extends PSLEvaluator{
...
//            calculatePC(state);//add by mengxu 2024.3.19
            ...
            double[][] preferences = new double[11][numObjective];//todo: need to update this
            ...
            multitreeClearingFirstMPSLGP.clearPopulationForParetoSetLearning(state, radius, capacity,
