...
public class SPEA2TourEpsilonLexicaseSelection extends SPEA2TournamentSelection {
    /** default base */
...
//        this.numCase = numIns;
    ...
    public List<Integer> getRandomSequenceInstance(EvolutionState state, int thread){
        ...
        int num_objectives = ((SPEA2MultiObjectiveFitness)state.population.subpops[0].individuals[0].fitness).getNumObjectives();
...
//                    System.out.println("epsilon selection index: " + allIndividualsIndex.get(0));
                ...
                if(((SPEA2MultiObjectiveFitness)allIndividuals.get(j).fitness).objectives[objectiveIndex]>bestFitness + epsilon){
