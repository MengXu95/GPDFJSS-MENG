...
public class MOEADm2mMultiObjectiveFitness extends MultiObjectiveFitness{
    ...
    {
        MOEADm2mMultiObjectiveFitness other = (MOEADm2mMultiObjectiveFitness) _fitness;
        return (rank == ((MOEADm2mMultiObjectiveFitness) _fitness).rank) &&
    ...
    public boolean betterThan(Fitness _fitness)
    {
        ...
        if (rank < ((MOEADm2mMultiObjectiveFitness) _fitness).rank)
            return true;
        else if (rank > ((MOEADm2mMultiObjectiveFitness) _fitness).rank)
            return false;
