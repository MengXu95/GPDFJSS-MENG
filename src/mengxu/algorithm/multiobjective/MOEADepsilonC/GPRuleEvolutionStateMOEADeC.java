...
public class GPRuleEvolutionStateMOEADeC extends GPRuleEvolutionState {
...
//	    if(generation == 0){ //modified for MOEAD by mengxu
...
//		System.out.println("Genotype diversity: " + genoDvalue);
		//todo: not right for multiobjective
...
//		System.out.println("PC diversity: " + pcDvalue);
		...
		diversities.add(0.0);
//		diversities.add(phenoDvalue); //original
		diversities.add(0.0);
//		diversities.add(entroDvalue); //original
		diversities.add(pseIsoDvalue);
		diversities.add(edit1Dvalue);
		diversities.add(edit2Dvalue);
		diversities.add(0.0); //original
