...
public class MutationPipelinePhenotypeBreeding extends GPBreedingPipeline
    {
    ...
    public Object clone()
        {
        MutationPipelinePhenotypeBreeding c = (MutationPipelinePhenotypeBreeding)(super.clone());
    ...
    public int produce(final int min,
        ...
        boolean similarWithParent = false;//add by mengxu 2023.06.19
...
//                }
            ...
            if(((GPRuleEvolutionStateMO)state).useParentOffspringDistanceLimitation){
                Individual[] parents = new Individual[1];
                parents[0] = i;
                nonduplicate = ((NSGA2EvaluatorNoEnvironmentalSelectionPhenotypeBreeding)state.evaluator).phenotypeSimilarityChecking(state,j);
                similarWithParent = ((NSGA2EvaluatorNoEnvironmentalSelectionPhenotypeBreedingSimilarityChecking)state.evaluator).phenotypeSimilarityCheckingWithParents(state,parents,j);
                if(nonduplicate && similarWithParent){
                    inds[q] = j;
                }
                else{
                    n--;
