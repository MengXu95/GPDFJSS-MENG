 ...
 */
public class AllIndexAllSwapCrossoverPipelinePhenotypeBreeding extends CrossoverPipeline {
    /**
...
//            }
          ...
          //  System.out.println(parents[1].trees.length);
            ...
            //add by mengxu 2023.06.06
            nonduplicate_j1 = ((NSGA2EvaluatorNoEnvironmentalSelectionPhenotypeBreeding)state.evaluator).phenotypeSimilarityChecking(state,j1);
            if(nonduplicate_j1){
                inds[q] = j1;
                q++;
            }
...
//            q++;
            ...
            if (q<n+start && !tossSecondParent)
                ...
                nonduplicate_j2 = ((NSGA2EvaluatorNoEnvironmentalSelectionPhenotypeBreeding)state.evaluator).phenotypeSimilarityChecking(state,j2);
                if(nonduplicate_j2){
                    inds[q] = j2;
                    q++;
                }
