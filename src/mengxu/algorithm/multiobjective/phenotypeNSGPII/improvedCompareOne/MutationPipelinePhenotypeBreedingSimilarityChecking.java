...
public class MutationPipelinePhenotypeBreedingSimilarityChecking extends GPBreedingPipeline
    {
    ...
    public Object clone()
        {
        MutationPipelinePhenotypeBreedingSimilarityChecking c = (MutationPipelinePhenotypeBreedingSimilarityChecking)(super.clone());
...
//                }
            ...
            nonduplicate = ((NSGA2EvaluatorNoEnvironmentalSelectionPhenotypeBreedingSimilarityChecking)state.evaluator).phenotypeSimilarityChecking(state,j);
            if(nonduplicate){
                inds[q] = j;
            }
            else{
