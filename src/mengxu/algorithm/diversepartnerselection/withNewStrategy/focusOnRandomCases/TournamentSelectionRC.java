...
public class TournamentSelectionRC extends SelectionMethod implements SteadyStateBSourceForm {
...
//        System.out.println();
    ...
    public int produce(int subpopulation, EvolutionState state, int thread) { //epsilon lexicase selection
        if(state.random[thread].nextBoolean()){
            ...
            return produceTournamentOnPoorCases(subpopulation, state, thread);
        }
