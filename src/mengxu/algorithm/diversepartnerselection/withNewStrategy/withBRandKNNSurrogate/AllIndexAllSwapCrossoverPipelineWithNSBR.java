 ...
 */
public class AllIndexAllSwapCrossoverPipelineWithNSBR extends CrossoverPipeline {
    /**
...
//        double[][] poolIndPC = phenotypicForSurrogateV1.phenotypicIndividual(this, ClearingEvaluator.phenoCharacterisation, archiveInds.get(0));
        ...
        for (int sub = 0; sub < state.population.subpops.length; sub++) {
            for (int i = 0; i < offspring.size(); i++) //
            {
                ...
                ((OneInstanceMultiCaseMultiObjectiveFitnessDPS)individual.fitness).multiInstanceMultiObjectiveFitness=fitnessesForModel[sub][index].clone();
        ...
        for (int i = 0; i < offspring.size(); i++) {
            ...
            for (int j = i+1; j < offspring.size(); j++) {
                ...
                if (numWinners < capacity) { //when set capacity to 1, the code will never go to here
                    ...
                    int caseNum = ((OneInstanceMultiCaseMultiObjectiveFitnessDPS)offspring.get(j).fitness).multiInstanceMultiObjectiveFitness.length;
                    double[][] caseFitness = new double[caseNum][1];
                    for(int c=0; c<caseNum; c++){
                       caseFitness[c][0] = Double.MAX_VALUE;
                    }
                    ((OneInstanceMultiCaseMultiObjectiveFitnessDPS)offspring.get(j).fitness).setMultiInstanceFitness(state, caseFitness);
                    //fzhang 2019.9.11
...
//        {
//            if(((OneInstanceMultiCaseMultiObjectiveFitnessDPS)o1.fitness).fitnessMeanNoBestNoWorst() <
//                    ((OneInstanceMultiCaseMultiObjectiveFitnessDPS)o2.fitness).fitnessMeanNoBestNoWorst())
//                return -1;
//            if(((OneInstanceMultiCaseMultiObjectiveFitnessDPS)o1.fitness).fitnessMeanNoBestNoWorst() ==
//                    ((OneInstanceMultiCaseMultiObjectiveFitnessDPS)o2.fitness).fitnessMeanNoBestNoWorst())
//                return 0;
...
//        Comparator<Individual> comp = (Individual o1, Individual o2) ->
//        {
//            if(((OneInstanceMultiCaseMultiObjectiveFitnessDPS)o1.fitness).fitnessMedian() <
//                    ((OneInstanceMultiCaseMultiObjectiveFitnessDPS)o2.fitness).fitnessMedian())
//                return -1;
//            if(((OneInstanceMultiCaseMultiObjectiveFitnessDPS)o1.fitness).fitnessMedian() ==
//                    ((OneInstanceMultiCaseMultiObjectiveFitnessDPS)o2.fitness).fitnessMedian())
//                return 0;
...
//    }
    ...
    public static void sortOffspring(Individual[] ind) //baseline used good results
    {
        Comparator<Individual> comp = (Individual o1, Individual o2) ->
        {
