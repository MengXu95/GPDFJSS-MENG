...
public class DiversePartnerSelectionNS extends SelectionMethod implements SteadyStateBSourceForm {
...
//            System.out.println("xcover/mutate/repro probability: " + newXoverProb + "/" + newMutationProb + "/" + originalReproducProb);
...
//        double[][] normalisationRecipient = ((MultiInstanceMultiObjectiveFitness)recipient.fitness).getMultiInstanceMultiObjectiveNormalisation();
//        Individual donor = oldinds[donorIndex];
//        double[][] normalisationDonor = ((MultiInstanceMultiObjectiveFitness)donor.fitness).getMultiInstanceMultiObjectiveNormalisation();
//
//
//        double advantage = 0;
//
...
//    }
    ...
    public boolean getCanXover(Individual[] oldinds, int recipientIndex, int donorIndex){
        ...
        for(int i=0; i<normalisationRecipient.length; i++){
            ...
            //the following is the original one used for GECCO
//            if(ref >= 0){
//                if(bb0 == 0){
//                    advantage += 1; //modified by mengxu 2022.03.07
//                }
