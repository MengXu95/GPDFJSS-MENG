...
public class GPRuleEvolutionStateDPSNSBRKNNCase extends GPRuleEvolutionState {
...
//	public PhenoCharacterisation[] phenoCharacterisation;
	...
	public List<PhenoCharacterisation> sequencingPhenoCharacterisation;
	public List<PhenoCharacterisation> routingPhenoCharacterisation;
...
//		this.phenoCharacterisation = new PhenoCharacterisation[2];
		this.sequencingPhenoCharacterisation = new ArrayList<>();
		this.routingPhenoCharacterisation = new ArrayList<>();
	}
...
//	    statistics.postEvaluationStatistics(this); //log the best individual
		...
		PopulationUtils.sort(this.population);// add by mengxu 2024.4.22
...
//		System.out.println("Edit 2 diversity: " + edit2Dvalue);
		...
		//dynamic simulation
		this.sequencingPhenoCharacterisation = SequencingPhenoCharacterisation.defaultPhenoCharacterisationAllCases(this, simulation);
		this.routingPhenoCharacterisation = RoutingPhenoCharacterisation.defaultPhenoCharacterisationAllCases(this,simulation);


		PhenoCharacterisation[] phenoCharacterisation = new PhenoCharacterisation[2];
		phenoCharacterisation[0] = SequencingPhenoCharacterisation.defaultPhenoCharacterisation(simulation);
		phenoCharacterisation[1] = RoutingPhenoCharacterisation.defaultPhenoCharacterisation(simulation);
		...
		for(int subpop = 0; subpop < this.population.subpops.length; subpop++) {
			for (int ind = 0; ind < this.population.subpops[subpop].individuals.length; ind++) {
				multiCaseFitnessesForModel[subpop][ind] = ((OneInstanceMultiCaseMultiObjectiveFitness)this.population.subpops[subpop].individuals[ind].fitness).multiInstanceMultiObjectiveFitness.clone();
			}
		}
		...
		double[][][][] indsCharListsMultiTreeAllCases = phenotypicForSurrogateV1.phenotypicPopulationFixedDecisionsAllCases(this, this.sequencingPhenoCharacterisation, this.routingPhenoCharacterisation, true);

		this.indsCharListsMultiTreeGen = indsCharListsMultiTreeAllCases;
