 ...
 * Measure the edit distance diversity 1 of population.
 * It has been verified that this algorithm may be correct. Be careful!!!
 */

public class EditDistanceDiversityV1 {

    public EditDistanceDiversityV1(){

    }

    public double editDistanceDiversityV1(Individual[] individuals, Individual bestInd){
    ...
    public int sameChildrenOrdered(GPNode[] children1,
                                              GPNode[] children2) {
        int dis = 0;
...
//        System.out.println(editDistanceDiversityV1(individuals, ind1));
    }
}
