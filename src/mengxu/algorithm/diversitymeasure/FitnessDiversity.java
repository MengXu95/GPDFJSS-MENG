...
public class FitnessDiversity {
    ...
    public int fitnessDiversity(Individual[] individuals){
    ...
    public void check(Individual[] individuals, Map<Individual, Integer> map){
        for(int i=0; i< individuals.length; i++){
            ...
            for(int j=0; j<i; j++){
                ...
                MultiObjectiveFitness fitness_indInpop = (MultiObjectiveFitness) indInpop.fitness;
                if(fitness.equivalentTo(fitness_indInpop)){
                    flag = 1;
                    break;
                }
            }
