 ...
 */
public class AllIndexAllSwapCrossoverPipelineSemanticV1 extends CrossoverPipeline {
    /**
          ...
          //  System.out.println(parents[1].trees.length);
            ...
            if(((GPRuleEvolutionStateSemanticV1)state).generation > ((GPRuleEvolutionStateSemanticV1)state).generationForDoPCMap) {
                if(randPro < ((GPRuleEvolutionStateSemanticV1)state).limitPortsDoLocalSearch){
                    ...
                    List<double[]> PC_j1 = ((GPRuleEvolutionStateSemanticV1) state).calculatePC(j1);
                    ...
                    if (((GPRuleEvolutionStateSemanticV1) state).doSequencingLocalSearch) {
                        acceptLocalSearchSeq_j1 = ((GPRuleEvolutionStateSemanticV1) state).PCMap.localSearchAcceptSequencing(sequencingPC_j1, ((GPRuleEvolutionStateSemanticV1) state).localSearchAcceptDis);
                    }
                    if (((GPRuleEvolutionStateSemanticV1) state).doRoutingLocalSearch) {
                        acceptLocalSearchRout_j1 = ((GPRuleEvolutionStateSemanticV1) state).PCMap.localSearchAcceptRouting(routingPC_j1, ((GPRuleEvolutionStateSemanticV1) state).localSearchAcceptDis);
                    }

                    if ((((GPRuleEvolutionStateSemanticV1) state).doSequencingLocalSearch && acceptLocalSearchSeq_j1) || (((GPRuleEvolutionStateSemanticV1) state).doRoutingLocalSearch && acceptLocalSearchRout_j1))
                    {
                        inds[q] = j1;
                    ...
                    if (((GPRuleEvolutionStateSemanticV1) state).doSequencingExplore) {
                        if(((GPRuleEvolutionStateSemanticV1) state).focusOnWholeMap) {
                            acceptExploreSeq_j1 = ((GPRuleEvolutionStateSemanticV1) state).PCMap.exploreAcceptSequencingNonDuplicatedOffspringInMap(sequencingPC_j1, ((GPRuleEvolutionStateSemanticV1) state).exploreAcceptDis);
                        }
                        else {
                            acceptExploreSeq_j1 = ((GPRuleEvolutionStateSemanticV1) state).PCMap.exploreAcceptSequencingNonDuplicatedOffspringInCurrentGeneration(sequencingPC_j1, ((GPRuleEvolutionStateSemanticV1) state).exploreAcceptDis);
                        }
                    }
                    if (((GPRuleEvolutionStateSemanticV1) state).doRoutingExplore) {
                        if(((GPRuleEvolutionStateSemanticV1) state).focusOnWholeMap) {
                            acceptExploreRout_j1 = ((GPRuleEvolutionStateSemanticV1) state).PCMap.exploreAcceptRoutingNonDuplicatedOffspringInMap(routingPC_j1, ((GPRuleEvolutionStateSemanticV1) state).exploreAcceptDis);
                        }
                        else {
                            acceptExploreRout_j1 = ((GPRuleEvolutionStateSemanticV1) state).PCMap.exploreAcceptRoutingNonDuplicatedOffspringInCurrentGeneration(routingPC_j1, ((GPRuleEvolutionStateSemanticV1) state).exploreAcceptDis);
                        }
                    }

                    if ((acceptExploreSeq_j1 || acceptExploreRout_j1)) {
                        inds[q] = j1;
                        if(acceptExploreSeq_j1){
                            ((GPRuleEvolutionStateSemanticV1) state).PCMap.updateSequencingPCInCurrentGeneration(sequencingPC_j1);
//                            System.out.println("Add one more sequencing PC!");
                        }
                        if(acceptExploreRout_j1){
                            ((GPRuleEvolutionStateSemanticV1) state).PCMap.updateRoutingPCInCurrentGeneration(routingPC_j1);
...
//                    if(randPro_j2 < ((GPRuleEvolutionStateSemantic)state).proForLocalSearchAndExplore){
                        ...
                        List<double[]> PC_j2 = ((GPRuleEvolutionStateSemanticV1)state).calculatePC(j2);
                        ...
                        if(((GPRuleEvolutionStateSemanticV1)state).doSequencingLocalSearch) {
                            acceptLocalSearchSeq_j2 = ((GPRuleEvolutionStateSemanticV1) state).PCMap.localSearchAcceptSequencing(sequencingPC_j2, ((GPRuleEvolutionStateSemanticV1) state).localSearchAcceptDis);
                        }
                        if(((GPRuleEvolutionStateSemanticV1)state).doRoutingLocalSearch) {
                            acceptLocalSearchRout_j2 = ((GPRuleEvolutionStateSemanticV1)state).PCMap.localSearchAcceptRouting(routingPC_j2, ((GPRuleEvolutionStateSemanticV1)state).localSearchAcceptDis);
                        }

//                        if(acceptLocalSearchSeq_j2 && acceptLocalSearchRout_j2){
                        if ((((GPRuleEvolutionStateSemanticV1) state).doSequencingLocalSearch && acceptLocalSearchSeq_j2) || (((GPRuleEvolutionStateSemanticV1) state).doRoutingLocalSearch && acceptLocalSearchRout_j2))
                        {
                            inds[q] = j2;
                            ((GPRuleEvolutionStateSemanticV1)state).offspringIndexByLocalSearch.add(q); //add by mengxu 2023.07.06
                            q++;
...
//                    if(randPro_j2 < ((GPRuleEvolutionStateSemantic)state).proForLocalSearchAndExplore){
                        ...
                        if(((GPRuleEvolutionStateSemanticV1)state).doSequencingExplore) {
                            if(((GPRuleEvolutionStateSemanticV1) state).focusOnWholeMap){
                                acceptExploreSeq_j2 = ((GPRuleEvolutionStateSemanticV1)state).PCMap.exploreAcceptSequencingNonDuplicatedOffspringInMap(sequencingPC_j2, ((GPRuleEvolutionStateSemanticV1)state).exploreAcceptDis);
                            }
                            else{
                                acceptExploreSeq_j2 = ((GPRuleEvolutionStateSemanticV1) state).PCMap.exploreAcceptSequencingNonDuplicatedOffspringInCurrentGeneration(sequencingPC_j2, ((GPRuleEvolutionStateSemanticV1) state).exploreAcceptDis);
                            }
                        }
                        if(((GPRuleEvolutionStateSemanticV1)state).doRoutingExplore) {
                            if(((GPRuleEvolutionStateSemanticV1) state).focusOnWholeMap){
                                acceptExploreRout_j2 = ((GPRuleEvolutionStateSemanticV1)state).PCMap.exploreAcceptRoutingNonDuplicatedOffspringInMap(routingPC_j2, ((GPRuleEvolutionStateSemanticV1)state).exploreAcceptDis);
                            }
                            else {
                                acceptExploreRout_j2 = ((GPRuleEvolutionStateSemanticV1) state).PCMap.exploreAcceptRoutingNonDuplicatedOffspringInCurrentGeneration(routingPC_j2, ((GPRuleEvolutionStateSemanticV1) state).exploreAcceptDis);
                            }
                        }

                        if(acceptExploreSeq_j2 || acceptExploreRout_j2){
                            inds[q] = j2;
                            if(acceptExploreSeq_j2){
                                ((GPRuleEvolutionStateSemanticV1) state).PCMap.updateSequencingPCInCurrentGeneration(sequencingPC_j2);
//                                System.out.println("Add one more sequencing PC!");
                            }
                            if(acceptExploreRout_j2){
                                ((GPRuleEvolutionStateSemanticV1) state).PCMap.updateRoutingPCInCurrentGeneration(routingPC_j2);
//                                System.out.println("Add one more routing PC!");
                            }
                            ((GPRuleEvolutionStateSemanticV1)state).offspringIndexByExploration.add(q); //add by mengxu 2023.07.06
                            q++;
