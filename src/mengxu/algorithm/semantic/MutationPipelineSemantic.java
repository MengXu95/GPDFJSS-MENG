...
public class MutationPipelineSemantic extends GPBreedingPipeline
    {
    ...
    public Object clone()
        {
        MutationPipelineSemantic c = (MutationPipelineSemantic)(super.clone());
...
//                    if (randPro_j < ((GPRuleEvolutionStateSemantic) state).proForLocalSearchAndExplore) {
                        ...
                        if (((GPRuleEvolutionStateSemantic) state).doSequencingLocalSearch) {
                            acceptLocalSearchSeq_j = ((GPRuleEvolutionStateSemantic) state).PCMap.localSearchAcceptSequencing(sequencingPC_j, ((GPRuleEvolutionStateSemantic) state).localSearchAcceptDis);
                        }
                        if (((GPRuleEvolutionStateSemantic) state).doRoutingLocalSearch) {
                            acceptLocalSearchRout_j = ((GPRuleEvolutionStateSemantic) state).PCMap.localSearchAcceptRouting(routingPC_j, ((GPRuleEvolutionStateSemantic) state).localSearchAcceptDis);
                        }

                        if ((((GPRuleEvolutionStateSemantic) state).doSequencingLocalSearch && acceptLocalSearchSeq_j) || (((GPRuleEvolutionStateSemantic) state).doRoutingLocalSearch && acceptLocalSearchRout_j))
                        {
                            inds[q] = j;
                        ...
                        if (((GPRuleEvolutionStateSemantic) state).doSequencingExplore) {
                            acceptExploreSeq_j = ((GPRuleEvolutionStateSemantic) state).PCMap.exploreAcceptSequencing(sequencingPC_j, ((GPRuleEvolutionStateSemantic) state).exploreAcceptDis);
                        }
                        if (((GPRuleEvolutionStateSemantic) state).doRoutingExplore) {
                            acceptExploreRout_j = ((GPRuleEvolutionStateSemantic) state).PCMap.exploreAcceptRouting(routingPC_j, ((GPRuleEvolutionStateSemantic) state).exploreAcceptDis);
                        }
