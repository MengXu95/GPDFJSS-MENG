...
public class LispSimplifier {
    ...
    //add by mengxu to add preference, used for Pareto Set Learning 2024.03.15
    public static String simplifyExpressionWithPreference(String expression, double[] preferences) {
        expression = expression.trim();
        ...
        if (expression.charAt(0) == '(') {
            ...
            for (int i = 0; i < args.size(); i++) {
                String simplifiedArg = simplifyExpressionWithPreference(args.get(i),preferences);
                args.set(i, simplifiedArg);
            }

//            for (int i = 0; i < args.size(); i++) {
//                if(args.get(i)=="Pone"){
//                    args.set(i, preferences[0]);
//                }
//            }
