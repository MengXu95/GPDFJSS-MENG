 ...
 */
public class LastOperationDownloadStartEvent extends AbstractEvent{
    private LastOperationDownloadProcess process;

    public LastOperationDownloadStartEvent(double time, LastOperationDownloadProcess process) {
        super(time);
        this.process = process;
    }

    public LastOperationDownloadStartEvent(LastOperationDownloadProcess process) {
...
//        process.getOperationOption().setReadyTime(time);
        simulation.addEvent(new LastOperationDownloadFinishEvent(process));
    }
