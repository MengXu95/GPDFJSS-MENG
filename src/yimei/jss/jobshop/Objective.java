...
import yimei.jss.rule.operation.composite.SlackperRPTplusPT;
...
public enum Objective {
    ...
    MEAN_ENERGY_CONSUMPTION("mean-energy-consumption"),
...
//                return new SlackperRPTplusPT(RuleType.SEQUENCING);
    ...
    public ArrayList<AbstractRule> setOfBenchmarkSequencingRule() {
        ArrayList<AbstractRule> benchmarkRules = new ArrayList<>();
        benchmarkRules.add(new SPT(RuleType.SEQUENCING));
        benchmarkRules.add(new WSPT(RuleType.SEQUENCING));
        benchmarkRules.add(new ATC(RuleType.SEQUENCING));
        benchmarkRules.add(new WATC(RuleType.SEQUENCING));
