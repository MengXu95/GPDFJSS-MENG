 ...
 */
public class FirstOperationUploadProcess implements Comparable<FirstOperationUploadProcess> {
    ...
    public FirstOperationUploadProcess(WorkCenter toWorkCenter, OperationOption operationOption, double startTime) {
        this.toWorkCenter = toWorkCenter;
        this.operationOption = operationOption;
        this.startTime = startTime;
        this.finishTime = startTime + operationOption.getOperation().getUploadTime();
    }
    ...
    public String toString() {
        return String.format("([Entry,W%d], [J%d,O%d,O%d]: %.1f --> %.1f.\n",
                toWorkCenter.getId(), operationOption.getJob().getId(),
                operationOption.getOperation().getId(), operationOption.getOptionId(), startTime, finishTime);
    }

    @Override
    public int compareTo(FirstOperationUploadProcess other) {
    ...
    public boolean equals(Object o) {
        ...
        FirstOperationUploadProcess process = (FirstOperationUploadProcess) o;
    ...
    public int hashCode() {
        int result;
        long temp;
        result = toWorkCenter != null ? toWorkCenter.hashCode() : 0;
