...
//        }
    ...
    //todo: need to modify this two totalProcTime 2021.11.04
    public double getRealTotalProcTime() {
        double realTotalProcTime = 0;
        for(int i=0; i<processFinishEvents.size(); i++){
            realTotalProcTime += processFinishEvents.get(i).getProcess().getDuration();
        }
        return realTotalProcTime; //the time that really eas used to process the jobs
    }
    ...
    //todo: need modify, this also include transportation time
