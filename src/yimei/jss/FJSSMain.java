...
//            AbstractRule routingRule = new HEFT(RuleType.ROUTING);
            AbstractRule sequencingRule = GPRule.readFromLispExpression(RuleType.SEQUENCING, "(Min WIQ WKR)");
            AbstractRule routingRule = GPRule.readFromLispExpression(RuleType.ROUTING, "(- (Min TIS WIQ) (Min MWT W))");
