...
public class surrogateClearingMultitreeEvaluatorV2 extends NSGA2EvaluatorAssignSparsity {
...
//                    if (fitnessesForModelSubpop[i][0] == Double.MAX_VALUE || fitnessesForModelSubpop[i][1] == Double.MAX_VALUE) {
