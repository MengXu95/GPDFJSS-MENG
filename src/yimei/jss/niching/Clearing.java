...
public class Clearing {
    ...
    public static void clearPopulation(final EvolutionState state,
        ...
        for (int subpopNum = 0; subpopNum < state.population.subpops.length; subpopNum++) {//this is for CCGP not for MTGP
...
//                phenoCharacterisation = ((GPRuleEvolutionStateCVTMAPElites) state).phenoCharacterisation[subpopNum];
//            }
//            PhenoCharacterisation phenoCharacterisation = pc[subpopNum];//fzhang 2018.10.02  define two phenotype characteristic---phenoCharacterisation
            ...
            //keep using the manual rule, this is for comparing with my MAP-Elites methods modified by mengxu 2023.10.11
