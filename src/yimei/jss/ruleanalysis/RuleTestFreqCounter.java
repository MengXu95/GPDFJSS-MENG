...
public class RuleTestFreqCounter extends RuleTest {
    ...
    public void writeToCSV() {
        ...
        File csvFile = new File(targetPath + "/feature-freq-Routing.csv");
...
//                            featureFreqMtx[i][j] / numTerminals[i]);
    ...
    public static void main(String[] args) {
        String dir = "/Users/mengxu/Desktop/XUMENG/PhdMainCode/ToCheck/";
        String[] algos = new String[]{"RightDKNN1024"};
        String[] fsNames = new String[]{"relative-terminals"};
        String[] scenarios = new String[]{"max-flowtime-0.85-1.5", "max-flowtime-0.95-1.5",
                "mean-flowtime-0.85-1.5", "mean-flowtime-0.95-1.5",
                "mean-weighted-flowtime-0.85-1.5", "mean-weighted-flowtime-0.95-1.5"};
        ...
        for (int i = 0; i < algos.length; i++) {
            for (String scenario : scenarios) {
                trainPath = dir + algos[i] + "/trainResults/" + scenario + "/";
