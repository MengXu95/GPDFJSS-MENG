...
public class TestResult {
	...
	private List<List<Fitness>> generationalEnsembleEachTestFitnesses;  //generational things is a list to contain informaiton related
//	private List<List<Fitness>> generationalEnsembleValidationFitnesses;

	private List<List<Double>> generationalTrainEnsembleContribution;
	private List<List<Double>> generationalTestEnsembleContribution;

	private List<List<Double>> generationalTestEnsembleSpread;
...
//	private List<Fitness> bestEnsembleValidationFitness;
	...
	private DescriptiveStatistics generationalSequencingExploredStat;

	private DescriptiveStatistics generationalRoutingExploredStat;

	private DescriptiveStatistics generationalNumOffByLocalStat;

	private DescriptiveStatistics generationalNumOffByExploreStat;
	...
	public TestResult() {
		...
		generationalEnsembleEachTestFitnesses = new ArrayList<>();
		generationalTrainEnsembleContribution = new ArrayList<>();
		generationalTestEnsembleContribution = new ArrayList<>();
		generationalTestEnsembleSpread = new ArrayList<>();
	}

	public DescriptiveStatistics getGenerationalGenotypeDiversityStat() {
		return generationalGenotypeDiversityStat;
	}
	...
	public List<List<Double>> getGenerationalTestEnsembleContribution() {
		return generationalTestEnsembleContribution;
	}

	public List<List<Double>> getGenerationalTestEnsembleSpread() {
		return generationalTestEnsembleSpread;
	}

	public List<List<Double>> getGenerationalTrainEnsembleContribution() {
		return generationalTrainEnsembleContribution;
	}

	public void addGenerationalTrainEnsembleContribution(List<Double> trainEnsembleContribution) {
		generationalTrainEnsembleContribution.add(trainEnsembleContribution);
	}

	public void addGenerationalTestEnsembleContribution(List<Double> testEnsembleContribution) {
		generationalTestEnsembleContribution.add(testEnsembleContribution);
	}

	public void addGenerationalTestEnsembleSpread(List<Double> testEnsembleSpread) {
		generationalTestEnsembleSpread.add(testEnsembleSpread);
	}
...
//=========================================================================
	...
	public List<Fitness> getGenerationalEnsembleTrainFitnessesGen(int gen) {
		return generationalEnsembleTrainFitnesses.get(gen);
	}
	...
	public void addGenerationalEnsembleEachTestFitness(List<Fitness> f) {
		this.generationalEnsembleEachTestFitnesses.add(f);
	}

	public List<List<Fitness>> getGenerationalEnsembleEachTestFitnesses() {
		return generationalEnsembleEachTestFitnesses;
	}

	public List<Fitness> getGenerationalEnsembleEachTestFitnessesGen(int gen) {
		return generationalEnsembleEachTestFitnesses.get(gen);
	}
	...
	public Fitness getGenerationalEnsembleTestFitnessesGen(int gen) {
		return generationalEnsembleTestFitnesses.get(gen);
	}
	...
	//2021.04.15 mengxu read diversities into CSV-------------------------------------------
	public void setSequencingExploredStat(DescriptiveStatistics generationalSequencingExploredStat) {
		this.generationalSequencingExploredStat = generationalSequencingExploredStat;
	}

	public void setRoutingExploredStat(DescriptiveStatistics generationalRoutingExploredStat) {
		this.generationalRoutingExploredStat = generationalRoutingExploredStat;
	}

	public void setNumOffByLocalStat(DescriptiveStatistics generationalNumOffByLocalStat) {
		this.generationalNumOffByLocalStat = generationalNumOffByLocalStat;
	}

	public void setNumOffByExploreStat(DescriptiveStatistics generationalNumOffByExploreStat) {
		this.generationalNumOffByExploreStat = generationalNumOffByExploreStat;
	}
	...
	public double getGenerationalSequencingExploredStat(int gen) {
		return generationalSequencingExploredStat.getElement(gen);
	}

	public double getGenerationalRoutingExploredStat(int gen) {
		return generationalRoutingExploredStat.getElement(gen);
	}

	public double getGenerationalNumOffByLocalStat(int gen) {
		return generationalNumOffByLocalStat.getElement(gen);
	}

	public double getGenerationalNumOffByExploreStat(int gen) {
		return generationalNumOffByExploreStat.getElement(gen);
	}

	public DescriptiveStatistics getGenotypeDiversityStat() {
		return generationalGenotypeDiversityStat;
	}
	...
	public static TestResult readFromFile(File file, RuleTypeV2 ruleType, int numPopulations) {
