...
public class NSGAIIMultiTreeRuleTest{
	 ...
	 public static final long simSeed = 968356;
	    ...
	    public NSGAIIMultiTreeRuleTest(String trainPath, RuleTypeV2 ruleType, int numRuns,
	   ...
	   //fzhang 17.11.2018 test for multi-objectives
		...
		public void writeToCSV() {
	        ...
	        //for (int i = 0; i < 1; i++) {
				...
				TestResult result = NSGAIIMultipleTreeTestResult.readMOFromFile(sourceFile, ruleType, numTrees);
				//original
...
//                              testFit.getObjective(k));
		...
		public static void main(String[] args) {
			...
			NSGAIIMultiTreeRuleTest multipletreeruleTest = new NSGAIIMultiTreeRuleTest(trainPath, ruleType, numRuns, testScenario, testSetName, numTrees);
