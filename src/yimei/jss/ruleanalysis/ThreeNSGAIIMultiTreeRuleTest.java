...
public class ThreeNSGAIIMultiTreeRuleTest{
	 ...
	 public static final long simSeed = 968356;
	    ...
	    public ThreeNSGAIIMultiTreeRuleTest(String trainPath, RuleTypeV2 ruleType, int numRuns,
...
//	                    System.out.println(((MultiObjectiveFitness)result.getGenerationalTestFitness(j)).objectives[1]);
		...
		public static void main(String[] args) {
			...
			ThreeNSGAIIMultiTreeRuleTest multipletreeruleTest = new ThreeNSGAIIMultiTreeRuleTest(trainPath, ruleType, numRuns, testScenario, testSetName, numTrees);
