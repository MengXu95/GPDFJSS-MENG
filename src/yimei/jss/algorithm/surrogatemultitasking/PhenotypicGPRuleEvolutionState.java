...
//        }
    ...
    public Population preselection(){
        ...
        ((surrogateClearingMultitreeEvaluatorV2)evaluator).evaluatePopulation(this, true); //two functions here, 1. sort the individual, 2. only save original popsize inds
