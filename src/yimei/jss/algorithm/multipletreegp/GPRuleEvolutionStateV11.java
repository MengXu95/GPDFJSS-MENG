 ...
 *
 */
public class GPRuleEvolutionStateV11 extends GPRuleEvolutionState {
...
//							OneDimArchiveIndsDeletedBase.add(normalisedRank + 1/(normalisedGeneration + 1));//rank/generation
                            OneDimArchiveIndsDeletedBase.add(0.2*normalisedRank + 0.8/(normalisedGeneration + 1));//rank/generation //modified by meng, add a "()"
                        }
