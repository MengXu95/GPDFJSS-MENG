 ...
 *
 */
public class GPRuleEvolutionStateV4 extends GPRuleEvolutionState {
	...
	ArrayList<Double> OneDimArchiveIndsGens = new ArrayList<>(); //save which generation the individuals from
	@Override
