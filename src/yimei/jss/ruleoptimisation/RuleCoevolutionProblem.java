...
public class RuleCoevolutionProblem extends RuleOptimizationProblem implements GroupedProblemForm {
    ...
    public void preprocessIndividual(EvolutionState state,
                                     ...
                                     boolean prepareForFitnessAssessmentSubpop,
                                     boolean countVictoriesOnly) {
        if (prepareForFitnessAssessmentSubpop) {
            ((MultiObjectiveFitness)(individual.fitness)).trials = new ArrayList();
        }
    }
    ...
    public void postprocessIndividual(EvolutionState state,
                                      Individual individual,
                                      boolean assessFitnessSubpop,
                                      boolean countVictoriesOnly) {
            if (assessFitnessSubpop) {
